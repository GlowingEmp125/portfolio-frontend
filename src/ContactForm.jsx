      ...
      <div className=' flex justify-around md:flex-row flex-col-reverse  '>
        <div className=' flex flex-col'>
          <div className=' border-2 border-[#382e68] rounded-md   bg-[#130f2a] mb-3 md:w-[650px] w-[90%]  py-4 flex items-center flex-col '>
            <div className=' bg-[#382e68] rounded-md p-1 mb-2 '>
          ...
          <form action="" onSubmit={handleSubmit}>
            ...
            <div className=' flex  md:justify-between items-center md:flex-row  flex-col'>
              ...
              <input type="text" placeholder='First Name' onChange={handleChange} name='fname' value={data.fname} className=' w-[95%]  md:mb-0  mb-5 
                    md:w-[47%] p-2 rounded-md text-white border-2 border-[#6751b9] bg-[#130f2a]' required />

              <input type="text" placeholder='Last Name' onChange={handleChange} name='lname' value={data.lname} className=' w-[95%] md:w-[47%] p-2 rounded-md text-white border-2 border-[#6751b9] bg-[#130f2a]' required />

            </div>

            <div className=' flex  w-full my-6 items-center justify-center'>

              <input type="email" placeholder='Email' onChange={handleChange} name='email' value={data.email} className='w-[95%] md:w-full p-2 rounded-md text-white border-2 border-[#6751b9] bg-[#130f2a]' required />

            </div>

            <div className=' flex  w-full  my-6 justify-center items-center'>

              <textarea className=' w-[95%] md:w-full p-2 rounded-md text-white border-2 border-[#6751b9] bg-[#130f2a]' onChange={handleChange} name='message' value={data.message} rows={5} placeholder='Message' required></textarea>
