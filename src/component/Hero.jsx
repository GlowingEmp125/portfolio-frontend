...
const Hero = () => {
  ...
  let [text] = useTypewriter({ words: ["Web Developer", "Full Stack Developer", "React js", "Next js"], loop: {} })

  return (
    <div>
      <div className=' flex md:justify-between   md:flex-row  flex-col-reverse items-center'>

        <div className=' flex flex-col w-[100%] h-[60vh] md:w-[660px] md:h-[500px] mx-auto profile '>
        ...
        <div className='  flex flex-col md:w-[500px] md:h-[500px] mt-[100px]  w-[90%] md:my-5 profile  md:mr-32  border-r-red-300' >
